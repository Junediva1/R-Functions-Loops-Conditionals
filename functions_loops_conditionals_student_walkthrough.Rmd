...
test_temp <- c(16.50540, 26.942005, 32.591088, 8.580116, 28.003873, 28.542391, 20.976820, 21.173577, 21.048836, 18.769735)
...
```{r}
test_temp_mat <- matrix(c(16.50540, 26.942005, 32.591088, 8.580116, 28.003873, 28.542391, 20.976820, 21.173577, 21.048836, 18.769735), nrow = 2)
...
1.  Do 5 CodeWars problems in R. Share your solutions here:
    ...
    # Problem 1: Convert a Boolean to a String
    ...
    # Problem 4: Convert function that input string to uppercase
         makeUpperCase <- function(s) {
      upperCaseString <- toupper(s)
      return(upperCaseString)
    }
        
    # Problem #5 : Negative number
